...
.fs-body {
    ...
    /* Reduced top padding slightly but ensured left content is positioned properly */
    position: relative;
    z-index: 10;
    overflow: hidden;
    gap: 100px;
...
.fs-left {
    ...
    /* Align to top to manually offset from header */
    align-items: center;
    padding-top: 40px;
    /* Force space from fs-header */
}
...
.fs-play-btn {
    width: 64px;
    /* Restored size because 30px was too small for playback */
    height: 64px;
    background: white;
    color: black;
    border-radius: 50%;
